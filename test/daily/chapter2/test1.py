...
第三题 增加一个气温类型列，如果最大值大于20，代表高温，小于等于20代表低温
...
df[df['date'] == '2020年10月1日'].index
这行代码的含义是检索出 df 中 data 为 2020年10月1日
的行的索引, 这里的索引其实就是行号

得到行号之后在进行 df.drop 删除
